...
## Load your counts table into R, remember to change `counts_table.csv` with your file name

my_data <- read.csv("counts_table.csv", row.names = 1, header = T)

## Load your meta data into R and remember to replace `meta_data.csv` with your file name
