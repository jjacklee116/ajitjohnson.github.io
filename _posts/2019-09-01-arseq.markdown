...
2. **[comparison 1] e.g. control vs drug-A**<br>
  ...
  **KEGG pathway enrichment**<br>
  ...
  - Pathway diagrams
  - If there are significantly enriched pathways, the pathway diagram of the top 5 will be saved in this folder<br>
  **Sample relation plots**<br>
